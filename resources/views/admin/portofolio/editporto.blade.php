    ...
    <form action="{{ route('admin.porto.storePorto') }}" method="POST" class="flex" enctype="multipart/form-data">
        ...
        <div class="w-full flex flex-col">
            ...
            <div class="mt-12 mb-8 w-full flex flex-row">
                <!-- Card 1 -->
                <div class="ms-12 card drop-shadow p-2 rounded-xl shadow-md items-end" style="background-color: #FFFFFF;">
                    <label class="py-4 ps-4" for="image-container">Input Preview</label>
                    <div class="flex flex-col items-center">
                        <div class="image-container px-4 flex justify-center space-x-12" id="image_profile-container">
                            <img style="width: 300px; height:400px; object-fit: contain;"
                                src="{{ asset('storage/thumbnail/' . $content->thumbnail_image_url) }}" type="">
                    ...
                    <div class="card w-full auto-height p-2 py-8 rounded-md">
                        ...
                        <div class="mb-6 flex">
                            ...
                            <input type="text" id="github_url" name="github_url" class="w-full border rounded p-2"
                                value="{{ old('github_url') ? old('github_url') : $content->github_url }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card w-full bg-white rounded-sm shadow-md flex flex-col">
                    ...
                    <label for="dropzone-file"
                        ...
                        <input id="image_url" type="file" name="image_url[]" class="file-input" multiple
                            onchange="getImageContents(event, {$counter})" />
                    </label>
                </div>
            </div>
...
<script>
    ...
    function getImageContents(event, counter) {
        console.log(counter);
        var i = 0;
