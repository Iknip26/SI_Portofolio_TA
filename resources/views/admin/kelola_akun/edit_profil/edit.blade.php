...
<div class="row justify-content-center mt-3">
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('account.update_profil', $dosens->id) }}" enctype="multipart/form-data" method="post">
                    @csrf
                    @method("POST")
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ $dosens->name }}">
                            @if ($errors->has('name'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('contact') is-invalid @enderror" id="contact" name="contact" value="{{ $dosens->contact }}">
