...
<body  class="mx-auto"style="background-color: white;">
      ...
      <div class="container mx-auto flex justify-center items-center" style="vertical-align: middle; ">
        ...
        <div class="container mx-auto p-4 inline-block" style="background-color: #62B5B1; width: 620px; height: 80px;  border-radius: 15px;">
          <div class="flex justify-center items-center h-full">
            ...
            <a href="{{route('public.showcase')}}" class="text-white mx-4 text-1xl" style="font-size: 20px;">Showcase</a>
    ...
    <div class="carousel-inner" style="border-radius: 30px;">
        ...
        <div class="carousel-item" ssty>
            ...
            <div class="carousel-caption absolute bottom-10 w-full text-white p-4 ">
              <h1 class="text-center text-2xl font-bold">Kantor Arsip Gelar Pameran Kegiatan<br>Mahasiswa UGM Tempo Doloe</h1>
          </div>
        </div>
  ...
  <div class="card mx-auto p-2 " style="border-radius: 30px; max-width: 1220px; max-height: fit-content; margin-top: 10px;">
<div class="flex mx-auto shadow-lg rounded-lg overflow-hidden my-10" style="width: 1220px; border-radius: 30px;  background-color: #2D918C;">
  <div class="flex" style="width: 1220px; display: flex; flex-direction: row; align-items: flex-start;">
    <img style="width: 447px; height: 379px; border-radius: 60px; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 30px;" src="{{asset('asset/model.jpeg')}}" alt="Gambar">
    <div class="px-6 py-4" style="padding-top: 30px; padding-bottom: 10px; padding-left: 10px; padding-right: 30px;"  >
...
<div class="card mx-auto p-2 " style="border-radius: 30px; max-width: 1220px; max-height: fit-content;">
  <div class="container mx-auto p-2 text-center flex justify-center items-center" style="background-color: #62B5B1; width: 1220px; height: 122px; border-radius: 30px; ">
  ...
  <div class="flex items-center justify-center" style="margin-left: 90px; margin-right: 90px; margin-top: 40px;">
    <div class="flex" style="margin-bottom: 10px; width: 1220px;">
      <div class="w-1/2 mr-4 text-center flex justify-center items-center relative" style="border-radius: 15px; background-color: #62B5B1; width: 543px; height: 445px; margin-left: 40px;">
        <a href="showcase.html"><h1 class="absolute bottom-0 left-0 mb-4 ml-4 text-white text-3xl">TEAM</h1></a>
      </div>
      <div class="w-1/2 mr-4 text-center flex justify-center items-center relative" style="border-radius: 15px; background-color: #62B5B1; width: 543px; height: 445px; margin-left: 40px;">
        <a href="Portofolio.html"><h1 class="absolute bottom-0 left-0 mb-4 ml-4 text-white text-3xl">PORTOFOLIO</h1></a>
      </div>
    </div>

</div><br><br>

<div class="card mx-auto p-4 mt-4" style="background-color: #2D918C; border-radius: 30px; width: 1220px; height: max-content;">
  <div class="container mx-auto p-4 mt-10 mb-10">
    <div class="flex justify-center mx-auto">
      <div class="w-1/4 p-4 aspect-w-1 aspect-h-1 rounded ml-4 relative" style="background-color: white; width: 228px; height: 215px; border-radius: 15px;">
        <div class="absolute inset-0 flex items-center justify-center">
          <img src="{{asset('asset/softw.png')}}" style="align-items: center; width: 120px; height: 120px; margin-bottom: 40px;">
          <button class=" text-white font-bold py-2 px-4 rounded absolute bottom-4 left-1/2 transform -translate-x-1/2" style="background-color: #62B5B1; border-radius: 42px;">→</button>
        </div>
      </div>
      <div class="w-1/4 p-4 aspect-w-1 aspect-h-1 rounded ml-4 relative" style="background-color: white; width: 228px; height: 215px; border-radius: 15px; margin-left: 40px; ">
        <div class="absolute inset-0 flex items-center justify-center">
          <img src="{{asset('asset/softw.png')}}" style="align-items: center; width: 120px; height: 120px; margin-bottom: 40px;">
          <button class=" text-white font-bold py-2 px-4 rounded absolute bottom-4 left-1/2 transform -translate-x-1/2" style="background-color: #62B5B1; border-radius: 42px;">→</button>
        </div>
      ...
      <div class="w-1/4 p-4 aspect-w-1 aspect-h-1 rounded ml-4 relative" style="background-color: white; width: 228px; height: 215px; border-radius: 15px; margin-left: 40px; ">
        <div class="absolute inset-0 flex items-center justify-center">
          <img src="{{asset('asset/cyber.png')}}" style="align-items: center;  width: 120px; height: 120px; margin-bottom: 40px;">
          <button class=" text-white font-bold py-2 px-4 rounded absolute bottom-4 left-1/2 transform -translate-x-1/2" style="background-color: #62B5B1; border-radius: 42px;">→</button>
        </div>
      </div>
      <div class="w-1/4 p-4 aspect-w-1 aspect-h-1 rounded ml-4 relative" style="background-color:white;width: 228px; height: 215px;  border-radius: 15px; margin-left: 40px;">
        <div class="absolute inset-0 flex items-center justify-center">
          <img src="{{asset('asset/iot.png')}}" style="align-items: center;  width: 120px; height: 120px; margin-bottom: 40px;">
          <button class=" text-white font-bold py-2 px-4 rounded absolute bottom-4 left-1/2 transform -translate-x-1/2" style="background-color: #62B5B1; border-radius: 42px;">→</button>
        </div>
      </div>
    </div>
...
<form>
  ...
  <div class="relative">
      ...
      <input type="search" id="default-search" style="background-color: #62B5B1; color: white;" class="block w-full p-4 pl-10 " placeholder="Search by Topics" required>
